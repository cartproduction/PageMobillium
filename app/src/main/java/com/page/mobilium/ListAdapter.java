...
public class ListAdapter extends ArrayAdapter<DataList>{
    ...
    public ListAdapter(Context context, List<DataList> myDataset) {
        super(context, R.layout.item_layout, myDataset);
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        if(convertView == null){
            ...
            convertView = lInflater.inflate(R.layout.item_layout, null);
        }
